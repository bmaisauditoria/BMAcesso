object frmMenu: TfrmMenu
  ...
  object cmdSenha: TBitBtn
    ...
    TabOrder = 2
    OnClick = cmdSenhaClick
    Glyph.Data = {
      36050000424D3605000000000000360400002800000010000000100000000100
      08000000000000010000130B0000130B00000001000000010000084263000852
      ...
      
      0909000606060606060606060100000000000606060606060606}
  end
  object cmdSenhaok: TBitBtn
    Left = 266
    Top = 37
    Width = 148
    Height = 37
    Caption = 'Confirmar Usu'#225'rio'
    Default = True
    TabOrder = 3
    OnClick = cmdSenhaokClick
    Glyph.Data = {
      36050000424D3605000000000000360400002800000010000000100000000100
      08000000000000010000130B0000130B00000001000000010000084263000852
      84001084CE00ADCEE700299CEF0029A5EF00FF00FF004ABDFF0052F7FF006BF7
  ...
  object lkuUsuario: TDBLookupComboBox
    Left = 31
    Top = 43
    Width = 123
    Height = 24
  ...
  object lblSenha: TEdit
    ...
    Width = 86
    Height = 24
    Hint = 'Digite sua Senha de 4 Digitos'
    MaxLength = 4
  ...
  object cmdAtuUsuario: TBitBtn
    Left = 425
    Top = 41
    Width = 30
    Height = 30
    Hint = 'Atualiza Usu'#225'rios'
    ParentShowHint = False
    ShowHint = True
    TabOrder = 4
    OnClick = cmdAtuUsuarioClick
    Glyph.Data = {
      36050000424D3605000000000000360400002800000010000000100000000100
  ...
  object dadosaud: TMSConnection
    ...
    Server = 'LAPTOP-K3F18P09\SQLEXPRESS'
    LoginPrompt = False
    Left = 4
    Top = 79
  end
  ...
  object dbUsuario: TMSQuery
    Connection = dadosaud
    SQL.Strings = (
      'Select * from Usuarios '
      
        'where (MasterAud=1) or (MasterFin=1) or (MasterAgenda=1) or (Mas' +
        'terIso=1)'
      '')
    Left = 37
    Top = 79
  ...
  object SkinData: TSkinData
    ...
    Options = [xoPreview, xoToolbarBK, xoToolbarButton, xoFormScrollbar]
    Skin3rd.Strings = (
  ...
  object MSSQLMonitor: TMSSQLMonitor
    Left = 345
    Top = 79
  end
  object RvAcesso: TRvProject
    Engine = RvSystem
    ProjectFile = 'C:\Andros\BBAcesso\BBAcesso.rav'
    Left = 178
    Top = 80
  end
  ...
  object ExcelExport: TExcelExport
